...
class DefinitionTest(unittest.TestCase):
    ...
    def test_it_names_every_file_the_driver_includes(self) -> None:
...
class CompileTest(unittest.TestCase):
    ...
    def test_and_points_the_compiler_at_the_fetched_sources(self) -> None:
        command = build.compile_command(Path("/sources"), Path("/out/driver"))
...
class EntryTest(unittest.TestCase):
    ...
    @unittest.skipUnless(HAS_COMPILER, "no compiler available")
    def test_building_against_a_directory_holding_no_sources_fails_rather_than_passing(
        self,
    ) -> None:
