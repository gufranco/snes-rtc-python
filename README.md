...
**2** clocks · **329,630** operations compared against the reference, **0** disagreements · **15** places the manual and that reference part, each one written down · **503** tests · **100%** statement and branch coverage · no dependencies
